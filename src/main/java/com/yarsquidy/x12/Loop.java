...
public class Loop implements Iterable<Segment> {
	...
	/**
	 * Creates an empty instance of {@link Loop} and adds the loop as a
	...
	/**
	 * Inserts {@link Loop} as a child loop at the specified position.
	 *
	 * @param index
	 *            position at which to add the loop.
	 * @param loop a {@link Loop} object.
	 */
	 ...
	 * {@link Segment} object and adds the segment to the current Loop.
	 *
	 * @param segment
	...
	/**
	 * Adds {@link Segment} at the end of the current Loop
	 *
	 * @param segment
	 *            {@link Segment}
	 */
	...
	/**
	 * Creates an empty instance of {@link Segment} and adds the segment at
	...
	/**
	 * Takes a {@link java.lang.String} representation of segment, creates a
	 * {@link Segment} object and adds the segment at the specified
	...
	/**
	 * Adds {@link Segment} at the specified position in current Loop.
	 *
	 * @param index
	 *            position to add the segment.
	 * @param segment
	...
	/**
	 * Creates an empty instance of {@link Loop} and inserts the loop as a
	 ...
	 * @param name
	 *            name of the loop
	 * @return a new child {@link Loop} object
	 */
	 ...
	 * @param name
	 *            name of a loop
	 * @return {@link java.util.List}&lt;{@link Loop}&gt;
	 */
	...
	/**
	 * Returns the {@link Loop} at the specified position.
	 *
	...
	/**
	 * Getter for the field {@link Loop}.
	 *
	 * @return Parent Loop
	 */
	...
	/**
	 * Returns the {@link Segment} at the default position.
	 *
	 ...
	 *
	 * @return {@link java.util.Iterator}&lt;{@link Segment}&gt;
	 */
	...
	/**
	 * Creates a new {@link Loop} and replaces the child loop at the
	...
	/**
	 * Replaces child {@link Loop} at the specified position.
	 *
	 * @param index
	 *            position at which to add the loop.
	 * @param loop
